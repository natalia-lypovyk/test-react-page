...
const headerItems = [{headerText:'etchash',bodyText:'13.5 Gh'},
...
const Header = ()=>{
    return (
        ...
        <div className={'headerItems'}>
            {headerItems.map((value, index)=>(<HeaderItem headerText={value.headerText} bodyText={value.bodyText} key={index} />)
            )}
        </div>
